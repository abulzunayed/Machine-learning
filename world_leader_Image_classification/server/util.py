...
def load_saved_artifacts():
    ...
    with open("E:/World_leader_classification/server/artifacts/class_dictionary.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open("E:/World_leader_classification/server/artifacts/saved_model.pkl", 'rb') as f:
...
def get_b64_test_image_for_virat():
    with open("E:/World_leader_classification/server/b64.txt") as f:
        return f.read()
...
if __name__ == '__main__':
    ...
    #print(classify_image(None, "E:/ML_project/CelebrityFaceRecognition/server/test_images/federer2.jpg"))
